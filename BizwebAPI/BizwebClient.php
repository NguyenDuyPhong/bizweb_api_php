...
class BizwebClient {
	...
	public function getAccessToken($code, $redirect_url='') {
		// POST to  POST https://SHOP_NAME.bizwebvietnam.net/admin/oauth/access_token
	...
	// var_dump($baseurl);  
		...
		$request_headers[] = 'X-Bizweb-Access-Token: ' . $this->token; // Bizweb Authen.  
	...
	private function curlHttpApiRequest($method, $url, $query='', $payload='', $request_headers=array())
	{
		...
		if ($errno) throw new BizwebCurlException($error, $errno);
	...
	private function curlSetopts($ch, $method, $payload, $request_headers)
	{
		...
		curl_setopt($ch, CURLOPT_USERAGENT, 'ohBizweb-php-api-client');
	...
	private function shopApiCallLimitParam($index)
	{
		...
		$params = explode('/', $this->last_response_headers['http_x_Bizweb_shop_api_call_limit']);
		return (int) $params[$index];
	}	
}

class BizwebCurlException extends Exception { }
class BizwebApiException extends Exception
{
	protected $method;
	protected $path;
	protected $params;
